...
*/
// http://locahost:4000/movies/643c6a634bedd62fccbadae4
...
router.patch('/:id', async (req, res) => {
    try {
        ...
        const updateMovie = await Movie.findOneAndUpdate({_id: id}, info, returnOption);
        
       //4. Respond to client.
        res.status(200).json({
            message: `${updateMovie.title} has been updated successfully!`,
            updatedMovie, 
        });
    } catch (err) {
        errorResponse(res, err);
