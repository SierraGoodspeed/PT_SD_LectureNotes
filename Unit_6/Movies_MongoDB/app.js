...
// Create variable for our connection address variable from he .env
...
// Create a variable that is and event listener to check if connected
const db = mongoose.connection

// Ust the above varible to trigger event listener to check connection
db.once("open", () => log(`Connected: ${MONGO}`));

//Added to allow us to accept JSON from the body of our client.
