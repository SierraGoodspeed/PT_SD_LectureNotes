/* 
    ? Unite 2: Data Structures
    - How we organize our data.
    - Utilize arrays and use functions to interact with them.
...
// Indices       0          1        2         3
    ...
    console.log (list.length); // 4, number of items (1 higher than highest index)
...
// If needing to find highest indices, subtract 1 from the length 
    ...
    // Example 2:
    // Indices       0      1   2       3         4
    let avengers = ["Nick", 5, true, "Steve", "Bruce",
    // 5  (nested array )        6  
    ["Tony", true, 100], "Natasha"];
