...
/* 
  ...
  - forEach() helps us iterate an array performing a function once per element in the array via a callback function.
...
let mainArr = [1, 2, 3, 4, ];
// .forEach does NOT return anything, perfors an action on each item, does not retun a value
...
character = "Splinter"; // find will return true for splinter vs the value splinter  because we checked all items via including the index
console.log(
  "Find Ex 3: ",
