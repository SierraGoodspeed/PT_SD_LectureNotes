...
/* 
    - Encapsulated data and behavior an exposed interface
...
//* Encapsulation
// Allows us to have a set of data stored as a property.
...
console.log(`${tiny.name} goes woof`); // Not as flexible and clean code to the method
...
let daisy = new Dog("Daisy", "Tan and Whiter", "Scream");
console.log(daisy)
...
// Ex: Create a base class that has a method to help is calculate a tip amount with a given tab that has been created. 
class Tab {
    constructor (sub, tax) {
        this.subtotal = sub;
        this.tax = tax;
...
// Set up some variables to hold some information: sales tax, a tip percentage, and a generated a new bill/ Tab object 
let salesTax = 0.06
let tipPercent = 0.2;
