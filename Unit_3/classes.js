...
/* 
    ...
    4. The parameters of our constructed objects. Establishes the values of our new object.
...
//* Methods 
// generating/creating our own methods for use within our objects 
...
3. "This" keyword is referencing "Dry Goods" objects and adding to it's array of items
...
class Expense {
    ...
    static addUpchargeForProfit(wholesale) {
        ...
        // retun (so it accessible) the new expense
...
//anotherItemToSell.addUpchargeForProfit(3);  // anotherItemToSell.addUpchargeForProfit(3); TypeError: anotherItemToSell.addUpchargeForProfit is not a function
