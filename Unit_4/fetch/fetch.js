/* 
    ...
    - Wonderful way to access data we are trying to obtain
        ...
        - Ex: data stored in database, cloud storage, or someones else's public database (via a public API)
...
// Store API in a global variable
...
fetch(testEndpoint)
    ...
    .then((res) => {
        ...
        return res.json(); // json-ifying our response into something we can ise and returning it
    })
    .then((data) => {
...
- JavaScript Object Notation
        ...
        */
        ...
        function seeDogPic(jsonDataFromFetch) {
            log("In seeDogPic function",jsonDataFromFetch);
         ...
         // "Variables are reused and referenced throughout a file. Parameters are only placeholders within functions." - Ben
