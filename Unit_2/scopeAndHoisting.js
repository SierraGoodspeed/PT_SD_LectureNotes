...
//console.log(`Out of the function/globally: ${z}`); //Z is not defined, local variable to the function only
...
/* 
    ...
    JavaScript only hoists declarations(let a;) , not initializations(a = 10; let a = 1-) .
