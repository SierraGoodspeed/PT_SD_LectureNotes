...
/* 
    If Else Statement: gives us a no (false) response response if the expression isn't true/valid. A true code block and a false code black.
*/
...
rain = false;
// Rich G: "alt(opt) + shift + down arrow .. can’t remember who gave the shortcut but its nice also for copying"
console.log(rain);
console.log (!rain);
