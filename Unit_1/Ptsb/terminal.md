...
We can type commands, manipulate files, execute programs, or open documents. More power and fast than a GUI*.

*(GUI) Graphical User Interface, using icons, menus, and windows for us to interact with in a visual way.)
...
- Touch or New Item
    ...
    - create a new file at the current directory path 
- Change Directory
    - `cd`
...
- Remove Here
    - `rm -r` or `rmdir` 
    - removes files/folders, <P style ="color: red">WARNING: these cannot be recovered as files permanently get deleted and not sent to the recycle bin.
